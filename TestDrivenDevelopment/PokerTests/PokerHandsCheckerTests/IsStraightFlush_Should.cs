...
{
    [TestFixture]
    public class IsStraightFlush_Should
    {
        // A straight flush is a hand containing five cards of sequential rank, all of the same suit.
        ...
        public void ThrowArgumentNullException_WhenNullIsPassed()
        {
            ...
            // Act & Assert
            Assert.Throws<ArgumentNullException>(() => handChecker.IsStraightFlush(null));
        }
        ...
        public void ThrowApplicationException_WhenHandHasLessThan5Cards()
        {
            ...
            // Act & Assert
            Assert.Throws<ApplicationException>(() => handChecker.IsStraightFlush(handMock.Object));
        }
        ...
        [Test]
        public void ReturnTrue_WhenAllCardsAreSequentialFace_AndSameSuit()
        {
            // Arrange
            var handChecker = new PokerHandsChecker();
            ...
            // Act
            var result = handChecker.IsStraightFlush(handMock.Object);
        ...
        [Test]
        public void ReturnFalse_WhenAllCardsAreSequentialFace_ButNotSameSuit()
        {
            // Arrange
            var handChecker = new PokerHandsChecker();
            ...
            card4Mock.SetupGet(c => c.Suit).Returns(CardSuit.Diamonds);
            card5Mock.SetupGet(c => c.Suit).Returns(CardSuit.Hearts);
